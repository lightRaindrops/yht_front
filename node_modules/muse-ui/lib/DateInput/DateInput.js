...
var PickerProps = (0, _extends3.default)({}, _Picker.TimePicker.props, _Picker.DatePicker.props, _props2.default.props);
      ...
      switch (this.type) {
        ...
        case 'month':
          return h(_Picker.DatePicker, {
            props: (0, _extends3.default)({}, this.generateDatePickerProps(), this.generatePickerProps(), {
        ...
        case 'dateTime':
          return h(_Picker.DateTimePicker, {
            props: (0, _extends3.default)({}, this.generateDatePickerProps(), this.generateTimePickerProps(), this.generatePickerProps(), {
        ...
        case 'time':
          return h(_Picker.TimePicker, {
            props: (0, _extends3.default)({}, this.generateTimePickerProps(), this.generatePickerProps(), {
              time: this.date,
              format: this.clockType
            }),
            on: {
