...
function createCompareFn(spy) {
  var hasWarned = function hasWarned(msg) {
    ...
    try {
      for (var _iterator = (0, _getIterator3.default)(spy.calls.allArgs()), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
function toHaveBeenWarnedInit() {
  ...
  afterEach(function (done) {
    ...
    for (var _i = 0; _i < _arr.length; _i++) {
      ...
      try {
        for (var _iterator2 = (0, _getIterator3.default)(console[type].calls.allArgs()), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
