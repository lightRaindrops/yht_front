...
exports.default = {
  ...
  methods: {
    ...
    createItem: function createItem(h) {
      ...
      var itemClass = ['mu-item', this.nestedOpen && this.nested ? 'is-open' : '', this.avatar ? 'has-avatar' : '', this.textline, (0, _utils.isNotNull)(listValue) && (0, _utils.isNotNull)(this.value) && listValue === this.value ? 'is-selected' : ''].join(' ');
